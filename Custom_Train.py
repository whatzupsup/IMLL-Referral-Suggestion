...
class CustomDataset_Train(torch.utils.data.Dataset):
    def __init__(self, root, transform, challenge='train', cv='1'):

        self.transform = transform
        self.cv = cv
        self.diag_0 = []; self.diag_1 = []; self.diag_2 = []; self.diag_3 = []; self.diag_4 = []; self.diag_5 = []; self.diag_6 = []; self.diag_7 = [];
        self.examples = [];
        self.train_tumor = [];
        self.train_nontumor = [];

        root_h5 = pathlib.Path(root)
        ...
        print('DIAG_0: %d, DIAG_1: %d, DIAG_2: %d, DIAG_4: %d, DIAG_5: %d, DIAG_6: %d, DIAG_7: %d, DIAG_8: %d'%((len(self.diag_0), len(self.diag_1), len(self.diag_2), len(self.diag_3), len(self.diag_4), len(self.diag_5), len(self.diag_6), len(self.diag_7))))
        ...
        random.seed(42); random.shuffle(self.diag_3)
        ...
        data_index_3 = np.arange(0, len(self.diag_3), 1).tolist(); data_index_cv_3 = np.array_split(data_index_3, 5)
        ...
        if self.cv=='1':
            ...
            idx_cv_3 = list(data_index_cv_3[0])+list(data_index_cv_3[1])+list(data_index_cv_3[2])+list(data_index_cv_3[3]) if challenge=='train' else list(data_index_cv_3[4])
            ...
            idx_cv_3 = list(data_index_cv_3[0])+list(data_index_cv_3[1])+list(data_index_cv_3[2])+list(data_index_cv_3[4]) if challenge=='train' else list(data_index_cv_3[3])
            ...
            idx_cv_3 = list(data_index_cv_3[0])+list(data_index_cv_3[1])+list(data_index_cv_3[3])+list(data_index_cv_3[4]) if challenge=='train' else list(data_index_cv_3[2])
            ...
            idx_cv_3 = list(data_index_cv_3[0])+list(data_index_cv_3[2])+list(data_index_cv_3[3])+list(data_index_cv_3[4]) if challenge=='train' else list(data_index_cv_3[1])
            ...
            idx_cv_3 = list(data_index_cv_3[1])+list(data_index_cv_3[2])+list(data_index_cv_3[3])+list(data_index_cv_3[4]) if challenge=='train' else list(data_index_cv_3[0])
        ...
        for i, input_file in enumerate(self.diag_3):
            if i in idx_cv_3:
                self.examples += [str(input_file)]
